...
<%
	String popedom = (String)session.getAttribute("globle_popedom"); 
	Hashtable ht = (Hashtable)session.getAttribute("globle_role");
%>
<HTML>
	<HEAD>
		<TITLE>Left</TITLE>
						...
						<DIV class="child" id="KB4Child">
							<TABLE cellSpacing="0" cellPadding="0" width="99%" border="0">
								<TBODY>
									...
									<TR>
										<TD class="box05" onmouseover="backgroundColorChange(this,'white');" onmouseout="backgroundColorChange(this,'');">
											<A class="cl_01" onclick="linkcolorchange(this)" href="${pageContext.request.contextPath }/system/elecUserAction_edit.do?userID=${sessionScope.globle_user.userID }&roleflag=1" target="mainFrame">用户管理</A>
										</TD>
									</TR>
									<%} %>
								...
								<TBODY>
									...
									<TR height=25>
										<TD background="${pageContext.request.contextPath }/images/b-info.gif" align="left" vAlign="middle">
											...
											&nbsp; <A class="cl" onclick="expand('KB5'); return false" href="#">&nbsp;审批流转</A>
										</TD>
									</TR>
								</TBODY>
							</TABLE>
					    ...
					    <DIV class="child" id="KB5Child">
							<TABLE cellSpacing="0" cellPadding="0" width="99%" border="0">
								<TBODY>
									<TR>
										<TD class="box05" onmouseover="backgroundColorChange(this,'white');" onmouseout="backgroundColorChange(this,'');">
											<A class="cl_01" onclick="linkcolorchange(this)" href="${pageContext.request.contextPath }/workflow/elecProcessDefinitionAction_home.do" target="mainFrame">审批流程管理</A>
										</TD>
									</TR>
									...
									<TR>
										<TD class="box05" onmouseover="backgroundColorChange(this,'white');" onmouseout="backgroundColorChange(this,'');">
											<A class="cl_01" onclick="linkcolorchange(this)" href="${pageContext.request.contextPath }/workflow/elecApplicationAction_templateHome.do" target="mainFrame">起草申请</A>
										</TD>
									</TR>
									...
									<TR>
										<TD class="box05" onmouseover="backgroundColorChange(this,'white');" onmouseout="backgroundColorChange(this,'');">
											<A class="cl_01" onclick="linkcolorchange(this)" href="${pageContext.request.contextPath }/workflow/elecApplicationAction_myTaskHome.do" target="mainFrame">待我审批</A>
										</TD>
									</TR>
									
									<TR>
										<TD class="box06" onmouseover="backgroundColorChange(this,'white');" onmouseout="backgroundColorChange(this,'');">
											<A class="cl_01" onclick="linkcolorchange(this)" href="${pageContext.request.contextPath }/workflow/elecApplicationAction_myApplicationHome.do" target="mainFrame">我的申请查询</A>
										</TD>
									</TR>
								</TBODY>
							</TABLE>
