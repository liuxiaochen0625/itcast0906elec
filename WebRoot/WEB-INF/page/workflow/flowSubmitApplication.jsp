...
<head>
	...
	<script type="text/javascript">
		function saveApplication(){
			 document.Form1.action="workflow/elecApplicationAction_saveApplication.do";
			 document.Form1.submit();	
		}
	</script>
</head>
<body>
		<form name="Form1" action="workflow/elecApplicationAction_saveApplication.do" method="post" enctype="multipart/form-data">
