					...
					<td class="ta_01" align="left" bgColor="#f5fafe" colspan="2">			
						<s:if test="#request.templateList!=null && #request.templateList.size()>0">
							<s:iterator value="#request.templateList" var="template">
								...
								<a id="Form2_" href="${pageContext.request.contextPath }/workflow/elecApplicationAction_flowSubmitApplication.do?applicationTemplateID=${template.id }">${template.name }</a>
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							</s:iterator>
						</s:if>
					</td>
