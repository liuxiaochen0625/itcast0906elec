					...
					<td class="ta_01" align="center" bgColor="#f5fafe" colspan="2">			
						<table cellspacing="0" cellpadding="1" rules="all" bordercolor="gray" border="1" id="DataGrid1"
							...
							<tr style="FONT-WEIGHT:bold;FONT-SIZE:12pt;HEIGHT:25px;BACKGROUND-COLOR:#afd1f3">
								...
								<td align="center" width="35%" height=22 background="${pageContext.request.contextPath }/images/tablehead.jpg">所用版本</td>
							...
							<s:if test="#request.templateList!=null && #request.templateList.size()>0">
								<s:iterator value="#request.templateList" var="template">
									<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
										...
										<td style="HEIGHT:22px" align="center" width="10%">
											<a href="workflow/elecApplicationTemplateAction_delete.do?id=<s:property value="%{#template.id}"/>" onclick="return confirm('你确定要删除  <s:property value="%{#template.name}"/>？')">
