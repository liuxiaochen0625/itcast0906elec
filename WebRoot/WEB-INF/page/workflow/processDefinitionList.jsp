				...
				<tr>
					<td class="ta_01" align="center" bgColor="#f5fafe" colspan="2">			
						<table cellspacing="0" cellpadding="1" rules="all" bordercolor="gray" border="1" id="DataGrid1"
							...
							<s:if test="#request.pdList!=null && #request.pdList.size()>0">
								<s:iterator value="#request.pdList" var="pd">
									<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
										...
										<td style="HEIGHT:22px" align="center" width="10%">
											<a href="workflow/elecProcessDefinitionAction_delete.do?key=<s:property value="%{#pd.key}"/>" onclick="return confirm('你确定要删除 <s:property value="%{#pd.name}"/> ？')">
											<img src="${pageContext.request.contextPath }/images/delete.gif" width="16" height="16" border="0" style="CURSOR:hand"></a>												
										</td>
										<td style="HEIGHT:22px" align="center" width="10%">
											<a href="#" onclick="openWindow('workflow/elecProcessDefinitionAction_downloadProcessImage.do?id=<s:property value="%{#pd.id}"/>','700','400');">
