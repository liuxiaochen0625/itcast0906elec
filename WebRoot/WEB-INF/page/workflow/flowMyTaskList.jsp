...
<body>
		...
		<form id="Form1" name="Form1" action="workflow/elecApplicationAction_myTaskHome.do" method="post" style="margin:0px;"> 
								...
								<s:iterator value="#request.applicationList" var="application">
									<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
										...
										<td style="HEIGHT:22px" align="center" width="10%">
											<a id="Form2_" href="${pageContext.request.contextPath }/workflow/elecApplicationAction_flowApprove.do?applicationID=${application.applicationID }&taskID=${application.taskID }"><img src="${pageContext.request.contextPath }/images/handle.gif" width="16" height="16" border="0" style="CURSOR:hand"></a>												
										</td>
