		    ...
		    style="BORDER-RIGHT:gray 1px solid; BORDER-TOP:gray 1px solid; BORDER-LEFT:gray 1px solid; WIDTH:100%; WORD-BREAK:break-all; BORDER-BOTTOM:gray 1px solid; BORDER-COLLAPSE:collapse; BACKGROUND-COLOR:#f5fafe; WORD-WRAP:break-word">
			    ...
			    <s:if test="#request.systemList!=null && #request.systemList.size()>0">
			    	<s:iterator value="#request.systemList" var="system">
					     <tr>
						   <td class="ta_01" align="center"  width="20%"><s:property value="%{#system.ddlCode}"/></td>
						   <td class="ta_01" align="center"  width="60%">
						   <input id="itemname" name="itemname" type="text" value="<s:property value="%{#system.ddlName}"/>"  size="45" maxlength="25"></td>
