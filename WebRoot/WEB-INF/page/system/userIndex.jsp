...
<%@ taglib uri="/struts-tags" prefix="s" %>
 ...
 <script language="javascript"> 
	function exportExcel(){
		...
		//方式二
		userName = encodeURI(userName,"UTF-8");//表示按照UTF-8的形式进行编码
		userName = encodeURI(userName,"UTF-8");//表示按照UTF-8的形式进行编码，相当于URLEncoded.encode()
		openWindow('${pageContext.request.contextPath }/system/elecUserAction_exportExcel.do?userName='+userName,'700','400')
	}
  </script>
...
<HTML>
	...
	<body >
		<s:form id="Form1" name="Form1" namespace="/system" action="elecUserAction_home.do" method="post" cssStyle="margin:0px;">
		...
		<s:form id="Form2" name="Form2" namespace="/system" action="elecUserAction_home.do" method="post">
		<table cellSpacing="1" cellPadding="0" width="90%" align="center" bgColor="#f5fafe" border="0">
			<TBODY>
				<TR height=10><td></td></TR>			
				<tr>
					...
					<td class="ta_01" align="right">
						...
						<input style="font-size:12px; color:black; height=20;width=80" id="BT_Export" type="button" value="导出" name="BT_Export" 
						 ...
						 <input style="font-size:12px; color:black; height=20;width=80" id="BT_Chart" type="button" value="人员统计" name="BT_Chart" 
							...
							<s:if test="#request.userList!=null && #request.userList.size()>0">
								<s:iterator value="#request.userList" var="user">
									<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
										...
										<td style="HEIGHT:22px" align="center" width="20%">
											<a href="#" onclick="openWindow('${pageContext.request.contextPath }/system/elecUserAction_edit.do?userID=<s:property value="%{#user.userID}"/>&viewflag=1','700','400');">
